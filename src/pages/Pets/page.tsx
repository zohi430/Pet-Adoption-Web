...
export default function Pets() {
  ...
  return (
    <section className="px-9 py-10 min-h-[calc(100vh-160px)] max-sm:px-4 max-sm:py-6">
      ...
      <h1 className="text-4xl max-sm:text-3xl font-extrabold leading-tight mb-2 text-[#2e8b57]">
        Browse Available Pets
      </h1>
      <p className="text-sm leading-relaxed my-1" style={{ color: 'var(--text-secondary)' }}>

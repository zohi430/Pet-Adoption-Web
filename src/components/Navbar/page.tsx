...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-wrap justify-between items-center px-8 py-3.5
      ...
      {/* Brand */}
      <Link to="/" className="text-xl font-extrabold text-white no-underline tracking-wide whitespace-nowrap">
        🐾 Pet Adoption
      </Link>
      ...
      {/* Nav list */}
      <ul className={`
        ${menuOpen ? 'flex bg-brand-third shadow-[0_6px_18px_rgba(0,0,0,0.15)]' : 'hidden'}
